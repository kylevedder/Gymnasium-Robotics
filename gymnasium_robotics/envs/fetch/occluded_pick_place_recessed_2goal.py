...
class FetchOccludedPickPlaceRecessed2GoalEnv(FetchOccludedPickPlaceRecessedEnv):
    def __init__(self, **kwargs):
        ...
        self.goal_indicator_offset = np.array([0,0.075,-0.075])
    ...
    def _sample_goal(self):  # Randomly select between goal 0 and 1 and place indicator
        ...
        self.model.body_pos[body_id] = goal_pos - self.goal_indicator_offset
...
if __name__ == "__main__":
    ...
    env = FetchOccludedPickPlaceRecessed2GoalEnv(camera_names=["external_camera_0", "behind_camera"], reward_type="dense", render_mode="depth_array", width=64, height=64)
    obs, _ = env.reset()
