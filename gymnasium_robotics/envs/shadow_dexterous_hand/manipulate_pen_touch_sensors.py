...
if __name__ == "__main__":
    env = PrivilegedMujocoHandPenTouchSensorsEnv(camera_names=["camera_hand"], log_image_keys=[False], target_position="ignore", target_rotation="xyz", touch_get_obs="boolean", reward_type="dense", render_mode="rgb_array", width=400, height=400, touch_visualisation="on_touch")
